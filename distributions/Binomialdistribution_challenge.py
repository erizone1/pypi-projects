...
class Binomial(Distribution):
    ...
    def __init__(self, p=0, n=0):
        ...
        #       You can use the calculate_mean() and calculate_stdev() methods defined below along with the __init__ function from the Distribution clas
        mu=self.n*self.p
    ...
    def pdf(self, k):
        ...
        return (1.0*math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n-k)))*math.pow(self.p,k)*math.pow(1-self.p,self.n-k)		
